...
//	long inputs;				//DI状态
//	long outputs;				//DO状态
//	//short running;               //运行状态 56
//	//short picture;     //拍照准备好 One   =1    =2 57
//	//short pause;       // 58
//	//short Ready_Start;   //准备好开始 59
//	//short Alarm; //60
//	//long  keycode;  //扫描码 61
//	//short status[18];
//};
...
public:
	Smp86xHandler(Smp86x* smp86x, int slave);
	~Smp86xHandler();
	...
	SMP86X_STATUS getSmp86xStatus(bool rt = false) const
	{
		...
		//if(_smp86x->modbus()->backend->backend_type == _MODBUS_BACKEND_TYPE_TCP)
		//{
		//}
